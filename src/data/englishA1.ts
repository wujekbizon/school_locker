...
export const ENGLISH_A1_DATA = [
  ...
  },
  {
    ...
    answers: [
      {
        option: "Where is we? I think this are Oxford street.",
        isCorrect: false,
      },
      {
        option: "Where are we? I think this are Oxford street.",
        isCorrect: false,
      },
      {
        option: "Where are we? I think this is Oxford street.",
        isCorrect: true,
      },
      {
  ...
  },
  {
    ...
    answers: [
      {
        option: "Are your friends from the UK? No, they are from the US.",
        isCorrect: true,
      },
      {
        option: "Is your friends from the UK? No, he is from the US.",
        isCorrect: false,
      },
      {
        option: "Are your friends from the UK? No, he is from the US.",
        isCorrect: false,
      },
      {
        option: "Is your friends from the UK? No, they are from the US.",
        isCorrect: false,
      },
    ],
  },
  {
    ...
    answers: [
      {
        option: "Hello, Maria. How are you? I are fine, thanks.",
        isCorrect: false,
      },
      {
        option: "Hello, Maria. How am you? I are fine, thanks.",
        isCorrect: false,
      },
      {
        option: "Hello, Maria. How are you? I 'm fine, thanks.",
        isCorrect: true,
      },
      {
        option: "Hello, Maria. How am you? I 'm fine, thanks.",
        isCorrect: false,
      },
    ],
  },
  {
    ...
    answers: [
      {
        option: "How old is Peter? I think he is 30 years old.",
        isCorrect: true,
      },
      {
        option: "How old are Peter? I think it is 30 years old.",
        isCorrect: false,
      },
      {
        option: "How old are Peter? I think he is 30 years old.",
        isCorrect: false,
      },
      {
        option: "How old is Peter? I think it is 30 years old.",
        isCorrect: false,
      },
    ],
  },
  {
    ...
    answers: [
      {
        option: "Is David and Molly here? Yes, we're next to the door.",
        isCorrect: false,
      },
      {
        option: "Are David and Molly here? Yes, we're next to the door.",
        isCorrect: false,
      },
      {
        option: "Is David and Molly here? Yes, they're next to the door.",
        isCorrect: false,
      },
      {
        option: "Are David and Molly here? Yes, they're next to the door.",
        isCorrect: true,
      },
    ],
  },
  ...
  },
  {
    ...
    answers: [
      {
        option:
          "A: Hi, Chris. This is my friend Jona. B: Hi, Jona. Nice to meet you.",
        isCorrect: true,
      },
      {
        option:
          "A: Hi, Chris. That is my friend Jona. B: Hi, Jona. Nice to meet you.",
        isCorrect: false,
      },
      {
        option:
          "A: Hi, Chris. These is my friend Jona. B: Hi, Jona. Nice to meet you.",
        isCorrect: false,
      },
    ],
  },
  ...
  },
  {
    ...
    answers: [
      {
        option: "Scotland is famous for it's rainy weather.",
        isCorrect: false,
      },
      {
        option: "Scotland is famous for their rainy weather.",
        isCorrect: false,
      },
  ...
  },
  {
    ...
    answers: [
      {
        option: "Susan lives on my street. His house is very near.",
        isCorrect: false,
      },
      {
        option: "Susan lives on I street. Her house is very near.",
        isCorrect: false,
      },
      {
        option: "Susan lives on my street. Her house is very near.",
        isCorrect: true,
      },
      {
        option: "Susan lives on I street. His house is very near.",
        isCorrect: false,
      },
    ],
  },
  {
    ...
    answers: [
      ...
      {
        option: "A: What are those? B: Their are postcards.",
        isCorrect: false,
      },
    ],
  },
  {
    ...
    answers: [
      {
        option: "I like this place and it's special atmosphere.",
        isCorrect: false,
      },
      {
        option: "I like this place and its special atmosphere.",
        isCorrect: true,
      },
      {
        option: "I like this place and isn't special atmosphere.",
        isCorrect: false,
      },
    ],
  },
  ...
  },
  {
    ...
    answers: [
      {
        option: "Our products are famous for its durability.",
        isCorrect: false,
      },
      {
        option: "Our products are famous for their durability.",
        isCorrect: true,
      },
      {
        option: "Our products are famous for they durability.",
        isCorrect: false,
      },
    ],
  },
  ...
  },
  {
    ...
    answers: [
      {
        option: "Valeria is from Italy, but his's in Ireland now.",
        isCorrect: false,
      },
      {
        option: "Valeria is from Italy, but she's in Ireland now.",
        isCorrect: true,
      },
      {
        option: "Valeria is from Italy, but her's in Ireland now.",
        isCorrect: false,
      },
    ],
  },
  {
    ...
    answers: [
      {
        option: "These are my friends. Their from Finland. ",
        isCorrect: false,
      },
      {
        option: "These are my friends. They're from Finland. ",
        isCorrect: true,
      },
  ...
  },
  {
    ...
    answers: [
      ...
      {
        option: "The apartment has his own private garden. ",
        isCorrect: false,
      },
      {
        option: "The apartment has it's own private garden. ",
        isCorrect: false,
      },
    ],
  },
  ...
  },
  {
    number: 54,
    question:
      "Choose a/an for the following words.  Do you have ___ umbrella? ",
    answers: [
  ...
  },
  {
    number: 61,
    question:
      "Is the plural form of the following singular words correct? : A university ⇒ universities",
    answers: [
  ...
  },
  {
    number: 62,
    question:
      "Is the plural form of the following singular word correct? : a sandwich ⇒ sandwiches",
    answers: [
      { option: "correct", isCorrect: true },
      { option: "incorrect", isCorrect: false },
    ],
  },
  {
    number: 63,
    question:
      "Is the plural form of the following singular word correct? : a street ⇒ streets",
    answers: [
      { option: "correct", isCorrect: true },
      { option: "incorrect", isCorrect: false },
    ],
  },
  {
    number: 64,
    question:
      "Is the plural form of the following singular word correct? : a rich man ⇒ rich mens",
    answers: [
  ...
  },
  {
    number: 65,
    question:
      "Is the plural form of the following singular word correct? : onet foot ⇒ two foots",
    answers: [
      { option: "correct", isCorrect: false },
      { option: "incorrect", isCorrect: true },
    ],
  },
  {
    number: 66,
    question:
      "Is the plural form of the following singular word correct? : an expensive watch ⇒ expensive watches",
    answers: [
      { option: "correct", isCorrect: true },
      { option: "incorrect", isCorrect: false },
    ],
  },
  {
    number: 67,
    question:
      "Is the plural form of the following singular word correct? : a dirty bag ⇒ dirty bags",
    answers: [
      { option: "correct", isCorrect: true },
      { option: "incorrect", isCorrect: false },
    ],
  },
  {
    number: 68,
    question:
      "Is the plural form of the following singular word correct? : a new phone ⇒ new phones",
    answers: [
      { option: "correct", isCorrect: true },
      { option: "incorrect", isCorrect: false },
    ],
  },
  {
    number: 69,
    question:
      "Is the plural form of the following singular word correct? : onet foot ⇒ two feet",
    answers: [
      { option: "correct", isCorrect: true },
      { option: "incorrect", isCorrect: false },
    ],
  },
  {
    number: 70,
    question:
      "Is the plural form of the following singular word correct? : One glass of wine ⇒ two glasses of wine",
    answers: [
      { option: "correct", isCorrect: true },
      { option: "incorrect", isCorrect: false },
    ],
  },
  {
    number: 71,
    question:
      "Write 'a/an' before the singular words and write the plural forms. __ bus ⇒ __ ",
    answers: [
  ...
  },
  {
    number: 72,
    question:
      "Write 'a/an' before the singular words and write the plural forms. __ nice family ⇒ nice __ ",
    answers: [
  ...
  },
  {
    number: 73,
    question:
      "Write 'a/an' before the singular words and write the plural forms. __ Italian child  ⇒ Italian __ ",
    answers: [
  ...
  },
  {
    number: 74,
    question:
      "Write 'a/an' before the singular words and write the plural forms. __ strong tooth ⇒ strong __ ",
    answers: [
  ...
  },
  {
    number: 75,
    question:
      "Write 'a/an' before the singular words and write the plural forms. __ nice dress ⇒ nice __ ",
    answers: [
  ...
  },
  {
    number: 76,
    question:
      "Write 'a/an' before the singular words and write the plural forms. __ angry wife ⇒ angry __ ",
    answers: [
  ...
  },
  {
    number: 77,
    question:
      "Write 'a/an' before the singular words and write the plural forms. __ uniform ⇒ __ ",
    answers: [
  ...
  },
  {
    number: 78,
    question:
      "Write 'a/an' before the singular words and write the plural forms. __ amazing websites ⇒ amazing __ ",
    answers: [
  ...
  },
  {
    number: 79,
    question:
      "Write 'a/an' before the singular words and write the plural forms. __ elephant ⇒ __ ",
    answers: [
  ...
  },
  {
    number: 80,
    question:
      "Write 'a/an' before the singular words and write the plural forms. __ empty library ⇒ empty __ ",
    answers: [
  ...
  },
  {
    ...
    answers: [
      {
        option: "With this makeup, your eyes look differents",
        isCorrect: false,
      },
      {
        option: "With this makeup, your eyes different look",
        isCorrect: false,
      },
  ...
  },
  {
    ...
    answers: [
      {
        option: "John has problems at home. Are his good marks?",
        isCorrect: false,
      },
      {
        option: "John has problems at home. Are his goods marks?",
        isCorrect: false,
      },
      {
        option: "John has problems at home. Are his marks good?",
        isCorrect: true,
      },
    ],
  },
