...
export default function Guide() {
  return (
    <div className="mb-8 flex w-full flex-col items-center gap-10 rounded-lg border border-border/40 bg-zinc-950 p-4 py-8 sm:px-8 xl:w-3/4">
      <div className="flex w-full flex-col gap-2">
        ...
        <p className="pt-6 text-sm text-zinc-300 sm:text-base">
