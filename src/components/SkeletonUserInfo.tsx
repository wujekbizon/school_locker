export default function SkeletonUserInfo() {
  return (
    <div
      role="status"
      className="flex h-full w-full animate-pulse flex-col justify-between lg:w-64"
    >
      <div className="flex flex-col gap-3">
        <div className="h-2 max-w-[160px] rounded-full dark:bg-gray-900"></div>
        <div className="flex h-64 w-64 items-center justify-center rounded-xl dark:bg-gray-900">
          <svg
